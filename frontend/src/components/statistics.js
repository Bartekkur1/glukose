...
class Statistics extends Component {
    ...
    dailyParse(arr, type) {
        ...
        p[1] = Math.round((p[1]/3)*100)/100
        p[2] = Math.round((p[2]/2)*100)/100
        p[3] = Math.round((p[3]/3)*100)/100
        return p;
    }
    ...
    async getData() {
        ...
        this.fillHours(this.state.sugars);
        this.fillHours(this.state.meals);
        this.fillHours(this.state.doses);
    }
